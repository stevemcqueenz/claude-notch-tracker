    ...
    private var notchRow: some View {
        HStack(spacing: 0) {
            providerIcon
                ...
                // Tap cycles provider (Claude → Codex → Antigravity); the Claude icon style is
                // picked from the right-click Icon menu.
                ...
                .accessibilityHint("Cycles between Claude, Codex and Antigravity")
